...
public class FoodAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editem4 = findViewById(R.id.editem4);


        btninsert = findViewById(R.id.btninsert);

        firebaseDatabase = FirebaseDatabase.getInstance();
        mref = firebaseDatabase.getReference().child("hotel");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String food4 = editem4.getText().toString().trim();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Task<Uri> downloadurl =taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                ...
                                newpost.child("food1").setValue(place2);

                                newpost.child("food2").setValue(place3);
                                newpost.child("food3").setValue(food3);
                                newpost.child("food4").setValue(food4);
